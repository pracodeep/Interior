...
<!-- Mirrored from code-theme.com/html/interior/office-interior.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 05:06:40 GMT -->
    ...
    <div id="wrapper">
        ...
        <div class="road">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <a href="index.php">Home</a><span>»</span><span>Office Interior</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="wprt-image-video w50">
                                            <img alt="image" src="images/services/Shabad-Office-banner-for-home-page.jpg">
                                ...
                                <div class="service-text">
                                    ...
                                    <p class="mb-4">Office design is of great importance to both employees and customers. For employees, who spend more time in office as compared to homes, it is crucial to create a space that's functional, visually appealing, comfortable, and inviting—all of which enhance their productivity and efficiency.
                                    ...
                                    <p class="mb-5">Office interiors have the potential to play a major role in influencing the emotions of employees, customers and the owners. Interior design consciously and subconsciously influences people’s moods and energy on a daily basis.This makes its design one of the most important decisions a company can make when creating an identity and healthy workplace.
                                        ...
                                        These days, interior designers are adopting newer technologies and innovations to make the designs and end products more attractive, comfortable and practical for customers.</p>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from code-theme.com/html/interior/office-interior.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Nov 2024 05:06:41 GMT -->
</html>
